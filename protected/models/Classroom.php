...
class Classroom extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			array('id_education, position, active, created', 'numerical', 'integerOnly'=>true),
			array('name', 'length', 'max'=>255),
			// The following rule is used by search().
			// @todo Please remove those attributes that should not be searched.
			array('id, id_education, name, position, active, created', 'safe', 'on'=>'search'),
		);
	}
	...
	public function search()
	{
		...
		$criteria->compare('active',$this->status);
